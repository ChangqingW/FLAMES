...
def demutiplex_sockeye(fq_dir, sockeye_tsv, out_fq):
    ...
    with open(sockeye_tsv) as sockey_file:
        ...
        for record in tsv_reader:
            id_bcumi_dict[record[read_id]] = (record[barcode], record[umi])
...
if __name__ == "__main__":
    demutiplex_sockeye("./sockeye_demultiplex_tests/in_fq", "./sockeye_demultiplex_tests/cell_umi_gene.tsv", "./sockeye_demultiplex_tests/out.fq.gz")
